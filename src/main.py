...
if __name__ == "__main__":
    ...
    preprocessed_crime_dataset_file_name_nan = 'crime_data_2010_2017_preprocessed_drop_nan.csv'
    preprocessed_crime_dataset_file_name_ohe = 'crime_data_2010_2017_preprocessed_ole.csv'
    ...
    # ud.preprocess_and_save(crime_dataset_file_name, preprocessed_crime_dataset_file_name_nan, False, 50000)
    # cp.preprocess_and_save(census_dataset_file_name, preprocessed_census_dataset_file_name)

    df = ccu.read_dataset(preprocessed_crime_dataset_file_name_nan)
    # census_df = ccu.read_dataset(preprocessed_census_dataset_file_name)
    #
